...
For this assignment, you also need to download the [data](http://alaska.epfl.ch/~dockermoocs/bigdata/wikipedia.dat) (133 MB) and place it in the folder: src/main/resources/wikipedia in your project directory.
