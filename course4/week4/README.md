...
For this assignment, you need to download the [data](http://alaska.epfl.ch/~dockermoocs/bigdata/atussum.csv) (164 MB) and place it in the folder src/main/resources/timeusage/ in your project directory.
